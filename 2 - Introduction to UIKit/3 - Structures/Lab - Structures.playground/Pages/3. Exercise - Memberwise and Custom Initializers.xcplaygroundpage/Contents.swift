...
var favoriteBook = Book(title: "Thinking Fast and Slow", author: "Daniel Kahneman", pages:464, price: 12.99)
...
var Laptop1 = Laptop(yearPurchased: 2023)
var Laptop2 = Laptop(screenSize: 15,repairCount: 1 ,yearPurchased: 2022)
/*:
...
struct Height{
    ...
    init(cm heightInCentimeters:Double){
...
var someoneHeight = Height(in:65)
print(someoneHeight.heightInCentimeters)
