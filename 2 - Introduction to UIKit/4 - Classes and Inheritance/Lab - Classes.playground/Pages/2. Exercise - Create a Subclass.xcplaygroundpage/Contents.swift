...
//print(falcon.weapon)
// property is defined in the figher context, not in the base class (SpaceShip) context
// subclass have the access of the base class properties and methods, not the opposite
...
print("destroyer power is \(destroyer.remainingFirePower)")
destroyer.fire()
print("destroyer power is \(destroyer.remainingFirePower)")
destroyer.fire()
print("destroyer power is \(destroyer.remainingFirePower)")
