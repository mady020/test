...
print("let keyword is used to declare constants which cannot be changed after initialization")
print("this is a compile time error, swift compiler throws an error like this 'Left side of mutating operator isn't mutable: 'friends' is a 'let' constant'")
