 ...
 */
print("* operator has more precedence than + operator, so this should evaluate to 20 i.e 10 + 10")
print(10 + 2 * 5)
...
print("* and / have equal precedence, so this should evaluate to 33 i.e 36 - 3")
print(4 * 9 - 6 / 2)
