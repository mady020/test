...
if let numberOfDays = daysInMonths["January"]{
    print("January has \(numberOfDays)")
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors." Print the resulting dictionary.
//var shapesArray = Array<Dictionary<String, Array<String>>>()
var dict:[String:[String]] = [
    "Shapes" : ["Rectangle", "Circle", "Square"],
    "Colors" : ["Red", "Black", "Green"]
]
var shapesArray = dict["Shapes"]
var colorsArray = dict["Colors"]
print(dict)
...
if let colorsArrayUnwrapped = colorsArray , let lastElement = colorsArrayUnwrapped.last{
    print("Last Element: \(lastElement)")
}
// unwrap [String?] (from colorsArray) to [String], then String?(from last) to String
...
//    print("Last Element: \(lastElement)")
//}
//dict["Colors"]!.last , force unwrapping [String?] to [String],
