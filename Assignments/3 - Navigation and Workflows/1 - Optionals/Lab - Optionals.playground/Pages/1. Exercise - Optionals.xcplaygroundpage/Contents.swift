...
print(userAge)
// userAge age is nil, because Int() initliazer cannot convert string to int as the string has a letter e, in this case it returns nil which is possible as it can  return Int? which means either an int or nil, this is helpful as the swift force the developer to explicitly declare a type which is going to be nil and manage that with if let or guard optional binding , this prevents from null pointer deferencing / segmentation fault from what i understand.
/*:
